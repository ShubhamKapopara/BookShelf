...
// router.post("/payment/CreateCustomer",payment.createCustomer);
// router.post("/payment/AddCustomerCard",payment.addCustomerCard);
// router.post("/payment/Charges",payment.paymentCharges);
