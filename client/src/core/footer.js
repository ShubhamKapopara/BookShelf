...
function Footer() {
  return (
    <footer className=" mx-40 relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-4">
          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color mb-7 text-base">
                A book selling website offers a diverse selection of books with
                prices, descriptions, and reviews. Customers can browse and
                purchase books using various payment methods. Shipping and
                return policies are also available. Additional features such as
                newsletters, social media links, and blogs are provided to keep
                customers updated on new releases, promotions, and events.
              </p>
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <a
                  href="javascript:void(0)"
                  className="text-dark max-w-xs transition duration-300 ease-in-out hover:scale-150 mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="8"
                    height="16"
                ...
                <a
                  href="javascript:void(0)"
                  className="text-dark transition duration-300 ease-in-out hover:scale-150 mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5]  sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width="16"
                    height="12"
